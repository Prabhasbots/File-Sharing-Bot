...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6991688781").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "🎬 File Name : {file_name}\n\n<b><a href='https://t.me/Baalveer_5_AJ'>🍿 Join Telegram Channel</a>")
